...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Chợ Nhà Mình – Đi chợ tươi mỗi ngày" },
      { name: "twitter:title", content: "Chợ Nhà Mình – Đi chợ tươi mỗi ngày" },
      { property: "og:description", content: "Đi chợ tươi mỗi ngày – mua đúng sạp quen. Ứng dụng giao hàng từ chợ truyền thống Việt Nam." },
      { name: "twitter:description", content: "Đi chợ tươi mỗi ngày – mua đúng sạp quen. Ứng dụng giao hàng từ chợ truyền thống Việt Nam." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/cc52b92a-23df-4361-952e-d7d7ef3949a0" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/cc52b92a-23df-4361-952e-d7d7ef3949a0" },
